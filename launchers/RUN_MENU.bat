...
echo 6. Tests  - Run tests and checks
echo 7. Git    - Show repository status
echo 9. Exit
echo.
...
if "%choice%"=="6" call "%~dp005_run_tests.bat" & pause & goto menu
if "%choice%"=="7" call "%~dp006_git_status.bat" & pause & goto menu
